					...
					<div class="card-body">
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab">
								<p>Student Association is a brain child of the Aditya Degree  College, Kakinada which is intended for multidimensional technical /non  technical skill development among students.</p>
