								...
								<!-- back content -->
								  <a href="downloads/ALL/1.DELOITTE.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>106</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/2.INFOSYS.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>1269</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/4.L&T.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>153</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/TCS.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>262</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/TECH MAHINDRA.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>162</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/ILM.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>1490</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
						...
						<div class="flip">
							...
							<div class="back">
								<!-- back content -->
								  <a href="" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>1924</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/HETERO.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>253</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
							...
							<div class="back">
								<!-- back content -->
								  <a href="downloads/ALL/DIVIS.pdf" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>501</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
						...
						<div class="flip">
							...
							<div class="back">
								<!-- back content -->
								  <a href="#" target="_blank" class="text-dark"> 
									<div class="inner text-center"> 
									  <h3 class="m-0 pt-4"><strong>32</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
							</div>
						</div>
