			...
			<div class="col-md-8">
				<div class="card card-warning2">
					<div class="card-header card-page-warning">
						<h4 class="title text-info">COURSES - <span class="text-warning">OFFERED</span><span class="float-right"><a href="downloads/NEW-COURSES-AUG-2020.pdf" class="btn btn-sm btn-primary"><i class="fa fa-file-pdf-o"></i> &nbsp; NEW COURSES BROCHURE</a></span></h4>
					</div>
					<div class="card-body std-info">
						<p>The Admissions in Aditya Group of Degree Colleges starts every year in the month of June up to August. The Aditya Group of Degree Colleges is affiliated to Andhra University, Visakhapatnam and Adikavi Nannaya University, Rajamahendravarm. The students can collect the application forms from the office of any degree college from the month of February by paying an amount of rupees hundred in the college cash counter.</p>
						<div class="acc-body">
