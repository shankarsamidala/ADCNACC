...
<?php
		...
		?>
					 ...
					 <div class="col-sm-5 col-sm-offset-1 col-md-offset-0 col-md-3 album-cover">
			             ...
			             <div class="img-label form-group"><strong><?php echo $album->name; ?></strong></div>
		            </div>
		            <?php if($count%4 == 0) : ?>
		            	</div>
		            	<div class="row">
        ...
        <?php 
        	...
        	if(isset($pagination->previous))
        		$prev = "gallery.php?b=".$pagination->cursors->before ;
        	else
        		$prev = "#";

        	if(isset($pagination->next))
        		$next = "gallery.php?a=".$pagination->cursors->after;
        	else
        		$next = "#";
        ?>
	        <!-- Pagination -->
