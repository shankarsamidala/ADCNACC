...
<?php
		...
		?>
					 ...
					 <div class="col-xs-10 col-xs-offset-1 col-sm-5 col-sm-offset-1 col-md-offset-0 col-md-3 album-cover" >
					 	<a href="<?php echo $pic; ?>"  data-toggle="lightbox" data-title="<?php echo  $count ."/". sizeof($json->data) . " ".$album_name; ?>"  data-gallery="popupgallery">
						 	<div class="portfolio-item" >
				                
				                    <img class="img-fluid form-group <?php echo $orientation;?>" src="<?php echo $pic; ?>" >
			            	</div>
        ...
        ?>
	        ...
	        <div class="row text-center">
	            <div class="col-lg-12">
	                <ul class="pagination">
	                    <li>
	                        <a class="btn btn-primary btn-sm" href="<?php echo $prev; ?>">&laquo;</a>
	                    </li>
	                    <li class="" id="page_num">
	                       <a href="#"> &nbsp; &nbsp;</a>
	                    </li>
	                    <li>
	                        <a class="btn btn-primary btn-sm" href="<?php echo $next; ?>">&raquo;</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
