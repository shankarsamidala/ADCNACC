...
<body class="sidebar-collapse" onLoad="getAlbums('<?php echo $quer; ?>')">
    ...
    <div class="wrapper">
        ...
        <div class="main">
			...
			<div class="vission-mission">
				...
				<img src="assets/img/forensic.jpg" class="img-fluid wow fadeIn">
				...
				<div class="row no-gutters">
					...
					<div class="col-md-6 col-lg-5" data-background-color="orangegray">
						<h4 class="p-2 m-0 text-center text-white" data-background-color="blue">3515 - Selections(2017-18)</h4>
						<marquee behavior="scroll" direction="up" loop="infinite" scrollamount="2" scrolldelay="1" onMouseOver="this.stop()" onMouseOut="this.start()">
  ...
  <tr>
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-4 wow slideInUp">
								<div class="card" data-background-color="orangegray">
									<form class="card-body" action="http://b.aditya.ac.in/analysis/website_studentlogin_code.php" method="post" name="frmDefault" onSubmit="return check_mobile()">
										<div class="text-center">
	...
	?>
	<li><a href="<?php echo $blog_permalink; ?>" target="_blank"><?php echo substr($blog_title, 0, 30); ?>...</a> <span><?php echo $blog_date; ?></span> &nbsp; <span><?php echo $blog_author; ?></span>
              <!--<p><?php //echo substr($blog_content, 0, 200); ?> <a href="<?php //echo $blog_permalink; ?>">Read More...</a></p>-->
            </li>
            <?php
	}
	?>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <img src="downloads/adat-2018.jpg" class="img-fluid">
    </div>
