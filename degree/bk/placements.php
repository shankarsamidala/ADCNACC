...
<head>
 ...
 app.controller('report', function($scope, $http) {
		...
		$scope.get_college_company_std= function(company,cname,colg){	
		    $scope.report=2;
			$scope.companyname=cname;
							...
							<div class="back">
								<!-- back content -->
								  <a href="" ng-click="get_company_std(x.compid,x.company_name)" class="text-dark"> 
									<div class="inner text-center" data-toggle="modal" data-target="#myModal2"> 
				...
				<div class="col-lg-2 col-md-3" ng-repeat="x in college_company">
					<div class="card-flip2">
						<div class="flip">
							...
							<div class="back">
								<!-- back content -->
								  <a href="" ng-click="get_college_company_std(x.compid,x.company_name,x.college)" class="text-dark"> 
									<div class="inner text-center" data-toggle="modal" data-target="#myModal2"> 
									  <h3 class="m-0 pt-4"><strong>{{x.students}}</strong></h3><p class="m-0 text-center">Selections</p>
									</div>
								  </a>
