...
<head>
 ...
 app.controller('report', function($scope, $http, $window) {
		...
		$scope.get_collegewiselist= function(col_id,cmp_name){
			console.log(col_id)
			console.log(cmp_name)
			$window.location.href="cmpwiseplacements.php?{{col_id}}?cmp_name";
			// $scope.loading=true;	
			...
			// $http.get('json/2020-21.json',myHeaders).success(function(data) {
			// 	//console.log(data);
...
<body class="sidebar-collapse" ng-app="placement" ng-controller="report">
	...
	<div class="container">	
		...
		<div class="m-3 text-center">
			...
			<a href="cmpwiseplacements.php?year=2021&campus=adcasl" ng-class="selcampus==x.id?'btn btn-primary btn-sm':'btn btn-info btn-sm'" ng-repeat="x in collegelist">{{x.college_code}}</a>
