					...
					<div class="card-body">
						<div class="tab-content" id="myTabContent">
							...
							<div class="tab-pane fade" id="roles" role="tabpanel" aria-labelledby="profile-tab">
								...
								<ul type="disc">
								  <li>To coordinate with Aditya Degree       College Kakinada campus Maintenance committee faculty members, to conduct       the meetings, discussing about Campus Management, taking suggestions from       higher level or management.</li>
								  ...
								  <li>Implementing       decisions taken in Aditya Degree College Kakinada campus Maintenance       committee meetings.</li>
								</ul>
							</div>
