					...
					<div class="card-body">
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab">
								<p>Press, Media  and Publicity Committee was established with a view to be the face of the  institute and the single touch- point for all the communications of Aditya  Degree College for Women, Kakinada. The primary role of the Press, Media and Publicity  Committee is to establish links with the local media and provide regular  reports and press releases on campus news and opportunities. The committee is  well-equipped with sophisticated machinery which are handled by trained and  competent students.&nbsp;The Committee also provides internal external media  support for the events organized by AWDCK like Convocations, Conferences,  Seminars, Sports weeks etc. The Press, Media and Publicity Committee also  designs and arranges printing materials to be used in different events at AWDCK.</p>
<h5>Vision</h5>
